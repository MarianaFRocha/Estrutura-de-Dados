...
A funcao adicionarAluno possui adição de RA aleatório (funcional mal)
...
adicionarAluno("Ti", "sadsasd", 10, 9.5, 8.73);
...
void adicionarAluno(char *primeiro_nome, char *ultimo_nome, float nota0, float nota1, float nota2)
{
  ...
  // cria um RA para adicionar ao aluno. Falta dar um jeito de atualizar o num_reg
  ra = criaRA();
