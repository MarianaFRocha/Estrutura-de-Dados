...
Com "indices" aleatórios e gerando 500.000 em menos de 1 segundo Arnaldo.
...
void geraArquivo(){
 ...
 // printf("\n\nFechando o arquivo...");
  fclose(arq); //ta tendo algum PROBLEMA na hora de fechar o arquivo
  /****************************************************************************************/

}
/*
void buscar(int RA_Aluno, int chave){

  if(RA_Aluno==chave){
      printf("\nencontradooooooooooo");
    }
    else
      printf("\nprocurando...");
...
int main()
{
   ...
   // printf("%d",n);
      ...
      int   comp_reg;
      int num_reg=TAM_MAX; // NAO EDITE AQUI //numero de registros é importante /*EDITE AQUI*/
