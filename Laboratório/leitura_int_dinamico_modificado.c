...
int main(int argc, char *argv[])
  {
	...
	arquivo=fopen(argv[3],"w"); //Abrindo o arquivo onde será escrito o vetor final do exercicio 3	

    if(argc < 4) //nome do arquivo de entrada deve ser passado na chamada do programa
  	{
